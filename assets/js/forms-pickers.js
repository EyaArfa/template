...
$(function () {
    // Select the element with ID "bs-datepicker-autoclose"
    var o = $("#bs-datepicker-autoclose");

    // Check if the element exists
    if (o.length) {
        // Initialize the datepicker with autoclose functionality
        o.datepicker({
            todayHighlight: true, // Highlight the current date
            autoclose: true,     // Automatically close the picker after selecting a date
            orientation: isRtl ? "auto right" : "auto left" // Set orientation based on RTL/LTR
        });
    }
});
